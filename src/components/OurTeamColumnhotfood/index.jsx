...
const OurTeamColumnhotfood = (props) => {
  return (
    <>
      <div className={props.className}>
        <div className="bg-white-A700 flex flex-row md:gap-10 gap-[471px] items-center justify-center p-[15px] w-full">
          ...
          <a href="/login"><Button className="border border-black-900 border-solid cursor-pointer font-light font-roboto leading-[normal] min-w-[140px] mr-[53px] my-[5px] py-[5px] text-black-900 text-center text-xl">
            {props?.loginbutton}
          </Button></a>
        </div>
...
OurTeamColumnhotfood.defaultProps = {
...
export default OurTeamColumnhotfood;
